...
- `infra/modules` は別リポジトリとして切り出す前提で管理しており、対応するモジュールリポジトリは[ [https://github.com/ReiNaka81/book-catalog-terraform-modules](https://github.com/ReiNaka81/book-catalog-terraform-modules) です。
